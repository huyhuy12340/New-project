...
export function CompareCanvas({
  ...
  // Calculate overlay scale factor (Figma coordinates are points, images might be 2x)
  // For simplicity, we assume the screenshot matches the Figma frame dimensions at 2x scale
  // But since we use object-contain, we need the actual rendered dimensions.
              ...
              <>
                ...
                <div className="relative flex flex-col gap-3">
                  ...
                  <div className="relative bg-white overflow-hidden rounded-lg">
                    <img 
                      src={baselineFrame?.thumbnail ?? frame.thumbnail ?? ""} 
            ...
            {mode === "overlay" && (
              <div className="relative flex flex-col gap-3">
                ...
                <div className="relative bg-black shadow-2xl overflow-hidden">
                   <img src={frame.thumbnail ?? ""} className="max-h-[60vh] w-auto block" />
                </div>
              </div>
            )}
          </div>
